...
# Configuration D: Lower learning rate with longer training
DATA_PATH = "data/emails.csv"
TEXT_COLUMN = "message"
OUTPUT_DIR = "./email-simcse-model-d"
MAX_LENGTH = 256
BATCH_SIZE = 64
NUM_EPOCHS = 8  # Increased from 5
LEARNING_RATE = 5e-6  # Decreased from 2e-5
TEMPERATURE = 0.05
WEIGHT_DECAY = 0.01
MAX_GRAD_NORM = 1.0
NUM_WORKERS = 4
