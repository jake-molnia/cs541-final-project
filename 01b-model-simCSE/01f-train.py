...
# Configuration F: More regularization
DATA_PATH = "data/emails.csv"
TEXT_COLUMN = "message"
OUTPUT_DIR = "./email-simcse-model-f"
MAX_LENGTH = 256
BATCH_SIZE = 32  # Decreased from 64
NUM_EPOCHS = 6  # Increased from 5
LEARNING_RATE = 2e-5
TEMPERATURE = 0.07  # Changed from 0.05
WEIGHT_DECAY = 0.05  # Increased from 0.01
MAX_GRAD_NORM = 1.0
NUM_WORKERS = 4
VALIDATION_SPLIT = 0.1
WANDB_PROJECT = "cs541-final-project"
WANDB_RUN_NAME = "EmailSimCSE-F"
# Modified parameters
